...
def cvss_predict_en():
  ...
  if vulnerability_form_en.validate_on_submit() and ('send' in request.form):
    predict_vuln = cve_classify.Predict(vulnerability_form_en.description_en.data, vectorizer2, vectorizer3, models)
...
def cvss_predict_pt():
  ...
  if vulnerability_form_pt.validate_on_submit() and ('send' in request.form):
    ...
    predict_vuln = cve_classify.Predict(txt_en, vectorizer2, vectorizer3, models)
...
if __name__ == '__main__':
  ...
  vectorizer2, vectorizer3 = cve_classify.LoadVectorizers()
